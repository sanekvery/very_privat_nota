      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Управление VPN сервисом</p>
          </div>
          <Link
            href="/"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-green-600 mt-1">72% конверсия</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Выручка (месяц)</p>
                <p className="text-3xl font-bold text-gray-900 mt-2">$12,450</p>
                <p className="text-sm text-green-600 mt-1">+8% к прошлому</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Серверы</p>
                <p className="text-3xl font-bold text-gray-900 mt-2">12</p>
                <p className="text-sm text-gray-600 mt-1">Все онлайн</p>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <button className="flex items-center gap-3 p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors text-left">
              ...
              <div>
                <p className="font-semibold text-gray-900">Добавить пользователя</p>
            ...
            <button className="flex items-center gap-3 p-4 bg-green-50 hover:bg-green-100 rounded-lg transition-colors text-left">
              ...
              <div>
                <p className="font-semibold text-gray-900">Добавить сервер</p>
                <p className="text-sm text-gray-600">Новый VPN сервер</p>
              </div>
            </button>
            ...
            <button className="flex items-center gap-3 p-4 bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors text-left">
              ...
              <div>
                <p className="font-semibold text-gray-900">Тикеты поддержки</p>
                <p className="text-sm text-gray-600">3 открытых</p>
              </div>
            </button>
            ...
            <button className="flex items-center gap-3 p-4 bg-orange-50 hover:bg-orange-100 rounded-lg transition-colors text-left">
              ...
              <div>
                <p className="font-semibold text-gray-900">Отчеты</p>
                <p className="text-sm text-gray-600">Статистика и аналитика</p>
              </div>
            </button>
          </div>
        </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">@user_12345 зарегистрировался</p>
                </div>
              ...
              <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1">
                  <p className="font-medium text-gray-900">Платеж получен</p>
                  <p className="text-sm text-gray-600">$29.99 за Premium план</p>
                </div>
              ...
              <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1">
                  <p className="font-medium text-gray-900">Сервер обновлен</p>
                  <p className="text-sm text-gray-600">US-East-1 перезапущен</p>
                </div>
              ...
              <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1">
                  <p className="font-medium text-gray-900">Новый тикет</p>
                  <p className="text-sm text-gray-600">Проблема с подключением</p>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Все запросы обрабатываются</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">PostgreSQL 16 работает</p>
                  </div>
                </div>
                <span className="text-green-600 font-semibold">Online</span>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Кеш активен</p>
                  </div>
                </div>
                <span className="text-green-600 font-semibold">Online</span>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">TON интеграция работает</p>
                  </div>
                </div>
                <span className="text-green-600 font-semibold">Online</span>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Настройка алертов</p>
                  </div>
                </div>
                <span className="text-yellow-600 font-semibold">Setup</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <div>
                <p className="font-semibold text-gray-900">Серверы</p>
                <p className="text-sm text-gray-600">VPN инфраструктура</p>
              </div>
            </Link>
            ...
            >
              ...
              <div>
                <p className="font-semibold text-gray-900">Платежи</p>
                <p className="text-sm text-gray-600">Транзакции и возвраты</p>
              </div>
            </Link>
            ...
            >
              ...
              <div>
                <p className="font-semibold text-gray-900">Мониторинг</p>
                <p className="text-sm text-gray-600">Метрики и алерты</p>
              </div>
            </Link>
            ...
            >
              ...
              <div>
                <p className="font-semibold text-gray-900">Новости</p>
                <p className="text-sm text-gray-600">Публикации и обновления</p>
              </div>
            </Link>

            <Link
              href="/admin/promo"
              className="flex items-center gap-3 p-4 border-2 border-gray-200 rounded-lg hover:border-pink-500 hover:bg-pink-50 transition-colors"
            >
              <svg className="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
              </svg>
              <div>
                <p className="font-semibold text-gray-900">Промокоды</p>
                <p className="text-sm text-gray-600">Скидки и акции</p>
              </div>
            </Link>
          </div>
        </div>
